...
func getDiscordUserInfoByCode(code string) (*DiscordUser, error) {
	...
	if res2.StatusCode != http.StatusOK {
		common.SysError("Failed to get Discord user information! Please check settings!")
		return nil, errors.New("Failed to get Discord user information! Please check settings!")
	}
	...
	if discordUser.UID == "" || discordUser.ID == "" {
		common.SysError("Discord user information is empty! Please check settings!")
		return nil, errors.New("Discord user information is empty! Please check settings!")
	}
