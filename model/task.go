...
// TaskBulkUpdate performs an unconditional bulk UPDATE by external task IDs.
// Use this only when the caller is keyed by TaskID instead of database primary key.
