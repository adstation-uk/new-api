...
import { ChevronLeft, Clock, Cpu, CreditCard, FileText, Globe, Info, Shield, Sparkles, Zap } from 'lucide-react'
    ...
    <div className="container py-10 max-w-5xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          {(() => {
            const docPath = path.join(process.cwd(), 'doc', `${modelId}.mdx`)
            const fallbackPath = path.join(process.cwd(), 'doc', 'test.mdx')
            let source = ''
            let hasDoc = false
